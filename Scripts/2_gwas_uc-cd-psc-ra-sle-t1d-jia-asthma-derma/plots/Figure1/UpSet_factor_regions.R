...
library(stringr)
#------ load the dataset -------------------------------------------------------
regions.factors <- fread('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/06_genomic_regions_all_traits_munged/factor.regions.txt', data.table = F) #take the original factor loci list
...
pdf(width = 6, height = 5, file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/plots/figure1/upset_plot_loci_ranges_factors.pdf')
...
pdf(width = 6, height = 5, file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/plots/figure1/venn_plot_loci_ranges_factors.pdf')
makeVennDiagram(ovl_f)
dev.off()
system('mv *log /project/aid_sharing/AID_sharing/outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/plots/figure1/logs')
