...
#save the csv
write.table(kegg.table, sep = ',', file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/tables/Supplementary_kegg.table.csv', row.names = F)
...
write.table(go.table, sep = ',', file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/tables/Supplementary_go.table.csv', row.names = F)
...
#save the table ascsv
write.table(go.table_top_10, sep = ',', file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/tables/go.table_top10.csv', row.names = F)




#--------- reactome table top --------------------------------------------------
react <- readRDS('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/10_genes_and_pathways/react_pathway_analysis.RDS')
...
#save the table ascsv
write.table(react.table, sep = ',', file = 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/tables/react.table.csv')
