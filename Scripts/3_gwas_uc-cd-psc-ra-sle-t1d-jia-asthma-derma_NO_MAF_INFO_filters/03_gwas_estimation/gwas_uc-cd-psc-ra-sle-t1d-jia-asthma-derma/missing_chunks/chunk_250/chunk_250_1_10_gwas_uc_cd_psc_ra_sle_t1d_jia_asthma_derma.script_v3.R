...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/03_estimation/missing_chunks/chunk_250/', paste0('250_',counter, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_3.RDS')))
