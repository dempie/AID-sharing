...
sle <- prepare_munge(sle,
              ...
              path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/sle_beta_bentham-2015.txt') 
...
crohn <- prepare_munge(crohn, 
                       ...
                       path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/crohn_delange-2017.txt')
...
uc <- prepare_munge(uc, 
                      ...
                      the_bp = 'BP',
                      to_remove = c('Min_single_cohort_pval', 'Pval_GWAS3', 'Pval_IIBDGC', 'Pval_IBDseq', 'HetPVal', 'HetDf', 'HetChiSq', 'HetISq'  ),
                      path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/uc_delange-2017.txt')
...
asthma_han <- prepare_munge(asthma_han, 
                            ...
                            the_SE = 'SE',
                            the_bp = 'BP',
                            path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/asthma_han-2020.txt'
                            )
head(asthma_han)
...
fwrite(psc_ok, file= 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/psc_ji-2016.txt',
...
jia <- prepare_munge(jia, 
                    ...
                    path=  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/jia_beta_lopezisac-2020.txt')
...
t1d_ok <-  data.frame(rsID = t1d$variant_id,  
                      ...
                      MAF= t1d$effect_allele_frequency,
...
fwrite(t1_ok_no_X, 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/t1d_chiou-2021.txt',
...
derma <- prepare_munge(derma, rsID = 'variant_id',
              ...
              path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/derma_sliz-2021.txt')
...
prepare_munge(okada_chr, 
              ...
              path =  'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_MAF_INFO/01_qc_summary_stats/ra_eu_okada-2014_chr_bp.txt')
