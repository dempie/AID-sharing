...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/05_gwas_ouput/chunks/chunk_203/chunk_203_1-10/', paste0('203_', counter, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS')))
