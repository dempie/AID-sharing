...
for(i in 1:length(top_10_pathways)){
  ...
  tabp[tabp$gene%in% shared_3,]$sharing <- 'three'
...
pdf('outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/plots/supplementary/bar_plot_top10GOterm.pdf', width = 10, height = 7)
