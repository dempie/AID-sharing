...
#-------f1 prepare GWAS -------------------------------------------------------
f1 <- fread('outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/03_estimation/summarystats_f1_.txt', data.table = F)
head(f1)
...
head(f1)
#-------f2 prepare GWAS -------------------------------------------------------
f2 <- fread('outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/03_estimation/summarystats_f2_.txt', data.table = F)
head(f2)
...
f2 <- prepare_munge(f2,
                    ...
                    the_Beta = 'Beta',
                    the_SE = 'SE',
                    path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/f2_ready_for_munge.txt'
)
head(f2)

#-------f3 prepare GWAS -------------------------------------------------------
f3 <- fread('outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/03_estimation/summarystats_f3_.txt', data.table = F)
head(f3)
...
f3 <- prepare_munge(f3,
                    ...
                    the_Beta = 'Beta',
                    the_SE = 'SE',
                    path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/f3_ready_for_munge.txt'
)
...
prepare_munge(uc,
              ...
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/uc_ready_for_munge_build37.txt'
)
head(uc)
...
prepare_munge(cd,
              ...
              the_SE = 'StdErr',
              to_remove = c( 'Min_single_cohort_pval', 'Pval_GWAS3', 'Pval_IIBDGC', 'Pval_IBDseq', 'HetPVal', 'HetDf', 'HetChiSq', 'HetISq'  ),
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/cd_ready_for_munge_build37.txt'
)
...
prepare_munge(psc,
              ...
              the_Beta = 'beta',
              the_SE = 'SE',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/psc_ready_for_munge_build37.txt'
)
...
prepare_munge(jia,
              ...
              the_Beta = 'Beta',
              the_SE = 'SE',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/jia_ready_for_munge_build37.txt'
)
...
prepare_munge(sle,
              ...
              the_Beta = 'Beta',
              the_SE = 'SE',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/sle_ready_for_munge_build37.txt'
)
...
prepare_munge(t1d,
              ...
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/t1d_ready_for_mung_build38.txt'
)
...
prepare_munge(asthma,
              ...
              the_Beta = 'beta',
              the_SE = 'SE',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/asthma_ready_for_munge_build37.txt'
)
...
prepare_munge(ra,
              ...
              the_Beta = 'Beta',
              the_SE = 'SEå',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/ra_ready_for_munge_build37.txt'
)
...
prepare_munge(derma,
              ...
              the_Beta = 'Beta',
              the_SE = 'SE',
              path = 'outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/derma_ready_for_munge_build38.txt'
)

#---------- MungeSumstats ------------------------------------------------------
#check the build
library(MungeSumstats)
a1 <- list.files('outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/')
my_paths <- as.list(paste0('outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/05_munge_for_nicola/ready_for_munge/', a1))
