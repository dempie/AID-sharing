...
#SBATCH --job-name=gwas_203
#SBATCH --partition=cpuq
#SBATCH --array=1-10
#SBATCH --cpus-per-task=1
#SBATCH --time=24:00:00
#SBATCH --output=gwas_chunk_203_1-10-%A-%a.log
...
Rscript chunk_203_1_10_gwas_uc_cd_psc_ra_sle_t1d_jia_asthma_derma.script_v3.R $SLURM_ARRAY_TASK_ID
