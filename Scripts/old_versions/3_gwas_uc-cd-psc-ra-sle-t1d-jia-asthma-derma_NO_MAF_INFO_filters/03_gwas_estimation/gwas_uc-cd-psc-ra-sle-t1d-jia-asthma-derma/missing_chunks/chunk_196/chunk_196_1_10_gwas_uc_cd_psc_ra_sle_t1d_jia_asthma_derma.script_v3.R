...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 196 )
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/3_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_NO_MAF_INFO/03_estimation/missing_chunks/chunk_196/', paste0('196_',counter, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_3.RDS')))
