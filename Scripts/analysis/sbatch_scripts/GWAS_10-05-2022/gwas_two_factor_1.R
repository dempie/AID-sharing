...
aid_sumstats <- readRDS('outputs/version3/04_output_sumstats-function/')
ldsc_model <- readRDS('outputs/version3/04_output_sumstats-function/')
...
saveRDS(output, file.path('outputs/version3/05_GWAS_results/GWAS_10-05-2022/chunks/', paste0(counter, '_gwas_10-05-22.RDS')))
