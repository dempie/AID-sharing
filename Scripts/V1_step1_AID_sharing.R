...
### add the chr:Position to the reference dataset
...
### match the columns with the reference 
...
#number of unmatched
sum(is.na(crohn_delange_rsID$SNP)) #1 209 146 over 9 million honestly a lot 


#check if some NA SNPs are in the reference
...
#calculate the SE from confidence interval #SE = (upper limit – lower limit) / 3.92.
