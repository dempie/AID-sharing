...
#The GWAS included in the three factor model are cuc-cd-psc-ra-sle-t1d-jia-asthma-derm
#as in step3
...
pdf('outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/04_sumstat_outputs/correlation_matrix_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.pdf', height = 16, width = 16)
