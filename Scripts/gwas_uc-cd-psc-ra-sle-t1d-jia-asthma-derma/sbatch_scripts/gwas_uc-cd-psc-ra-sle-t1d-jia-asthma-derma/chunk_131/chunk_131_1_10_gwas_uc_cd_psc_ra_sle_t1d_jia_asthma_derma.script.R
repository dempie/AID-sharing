...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/05_gwas_ouput/chunks/chunk_131/chunk_131_1-10/', paste0('131_', counter, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS')))
