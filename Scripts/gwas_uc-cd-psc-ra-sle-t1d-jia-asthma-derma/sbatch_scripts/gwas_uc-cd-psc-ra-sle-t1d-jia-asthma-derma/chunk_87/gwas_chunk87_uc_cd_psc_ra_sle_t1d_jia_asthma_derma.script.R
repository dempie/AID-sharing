...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 87)
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/05_gwas_ouput/chunks/chunk_87/', paste0(87, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS')))
