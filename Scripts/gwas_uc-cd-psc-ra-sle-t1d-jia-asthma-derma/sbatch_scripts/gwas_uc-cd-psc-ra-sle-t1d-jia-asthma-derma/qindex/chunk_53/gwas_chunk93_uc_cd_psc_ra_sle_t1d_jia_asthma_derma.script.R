...
crohn + uc  + psc + jia + sle + ra+ t1d + asthma+ derma ~ SNP
...
chunk_to_use <- split_sum_stats(aid_sumstats, 10000, 93)
...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/05_gwas_ouput/qindex/chunk_93/', paste0(93, '_qindex_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS')))
