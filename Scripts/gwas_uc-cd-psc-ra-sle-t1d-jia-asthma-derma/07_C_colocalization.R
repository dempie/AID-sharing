...
loci <- locus_lister(the_paths[c(1,2, 3)], gwas_names = gwas_names[c(1,2,3)] )
head(loci)
dim(loci) #573 12
...
saveRDS(shared_SNPs, 'outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/07_colocalization/hyprcoloc_all_against_all/shared_SNPs_all_traits.RDS')
...
saveRDS(res_coloc, 'outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/07_colocalization/hyprcoloc_all_against_all/hyprcoloc_all_against_all_outputs.RDS')
saveRDS(betas,'outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/07_colocalization/hyprcoloc_all_against_all/betas_all_against_all.RDS')
saveRDS(SE,'outputs/gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/07_colocalization/hyprcoloc_all_against_all/SE_all_against_all.RDS')




#-------------RUN hyprcoloc only on the three factors ---------------------------
