...
#---- crohn SE -----------------------------------------------------------------
cd <- fread('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/crohn_delange-2017.txt', data.table = F)
head(cd) 
is_se_logB(cd$Beta, cd$SE, cd$p) #SE logistic beta (effect column is beta as there are negative values)

#----- uc SE --------------------------------------------------------------------
uc <- fread('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/uc_delange-2017.txt', data.table = F)
head(uc)
...
t1d <- fread('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/t1d_chiou-2021.txt', data.table = F)
head(t1d)
...
file_names <- c('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/t1d_chiou-2021.txt', 
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/crohn_delange-2017.txt', 
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/uc_delange-2017.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/psc_ji-2016.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/jia_beta_lopezisac-2020.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/sle_beta_bentham-2015.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/ra_eu_okada-2014_chr_bp.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/asthma_han-2020.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/derma_sliz-2021.txt'
                )
...
system(' mv *.sumstats.gz outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/munged_files/')
system(' mv *log outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/log_munge/')


#-----ldsc function ------------------------------------------------------------
munged_files <- c('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/munged_files/t1d.sumstats.gz',
...
system('mv *log outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/log_ldsc/')

saveRDS(ldsc_output, 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/ldsc_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS')
...
pdf('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/correlation_matrix_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.pdf', height = 14, width = 14)
...
saveRDS(aid_factor, 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/model_uc-cd-psc-ra-sle-t1d-jia-asthma-derma.RDS') 


#----Sumstat function-----------------------------------------------------------


file_names_ok <- c('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/t1d_chiou-2021.txt', 
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/crohn_delange-2017.txt', 
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/uc_delange-2017.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/psc_ji-2016.txt',
                'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/jia_beta_lopezisac-2020.txt',
...
system('mv *log  outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/02_sumstats_function/log_sumstats/')
