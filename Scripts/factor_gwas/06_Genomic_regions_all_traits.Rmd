...
### add log(OR), beta, to asthma and psc

```{r}
asthma <- fread('outputs/rev_1/05_munge/munged/asthma_munged_build37.txt')
asthma$beta <- log(asthma$OR)
head(asthma)
fwrite(asthma, 'outputs/rev_1/05_munge/munged/asthma_beta_munged_build37.txt', sep = '\t', col.names = T, row.names = F, quote = F)

psc <- fread('outputs/rev_1/05_munge/munged/psc_munged_build37.txt')
psc$beta <- log(psc$OR)
head(psc)
fwrite(asthma, 'outputs/rev_1/05_munge/munged/psc_beta_munged_build37.txt', sep = '\t', col.names = T, row.names = F, quote = F)
```

## locus_lister function

This function identifies significant genomic regions with the locus.breaker fuction. Then creates a table of all the loci for all traits and puts them together.
...
my_paths <- list("outputs/rev_1/05_munge/munged/asthma_beta_munged_build37.txt",
              ...
              ###
                ...
                "outputs/rev_1/05_munge/munged/psc_beta_munged_build37.txt",
...
#plot venndiagram
pdf(width = 14, height = 14, file = 'outputs/rev_1/06_genomic_regions_all_traits_munged/venn_f1_f2_f3_loci.pdf')
...
pdf(width = 14, height = 14, file = 'outputs/rev_1/06_genomic_regions_all_traits_munged/upset_f1_f2_f3_loci.pdf')
