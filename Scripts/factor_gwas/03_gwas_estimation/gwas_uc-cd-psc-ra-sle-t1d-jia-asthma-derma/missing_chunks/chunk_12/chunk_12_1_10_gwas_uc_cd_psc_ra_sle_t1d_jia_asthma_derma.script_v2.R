...
saveRDS(output, file.path('/project/aid_sharing/AID_sharing/outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/03_gwas_estimation/missing_chunks/chunk_12/', paste0('12_',counter, '_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma_2.RDS')))
