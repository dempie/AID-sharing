...
for( i in c(1:length( list(F1_noNA, F2_noNA, F3_noNA)))){
  ...
  fwrite(to_save, paste0('outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/03_gwas_estimation/summarystats_f',i,'_.txt'), 
...
saveRDS(N_hat,'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/03_gwas_estimation/effective_sample_size_factors.RDS')
