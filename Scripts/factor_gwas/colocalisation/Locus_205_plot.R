...
#for( locus in unique(loci.table$pan_locus)){
  ...
  conditional.datasets$f1$results$rs415595$trait="F1"
  conditional.datasets$f1$results$rs415595$sub_trait="F1-rs415595"
  ...
  conditional.datasets$f3$results$rs767019$trait="F3"
  conditional.datasets$f3$results$rs767019$sub_trait="F3-rs767019"
  
   
  
  
  splitup.results=rbind(conditional.datasets$f1$results$rs12922863
                        ,conditional.datasets$f1$results$rs415595
                        ...
                        ,conditional.datasets$f3$results$rs767019)
  ...
  pdf("Locus_204_decomposition.pdf",height=21,width=30)
