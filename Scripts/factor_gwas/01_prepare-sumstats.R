...
sle <- prepare_munge(sle,
              ...
              path =  'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/sle_beta_bentham-2015.txt') 
...
crohn <- prepare_munge(crohn, 
                       ...
                       path =  'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/crohn_delange-2017.txt')
...
uc <- prepare_munge(uc, 
                      ...
                      the_bp = 'BP',
                      to_remove = c('Min_single_cohort_pval', 'Pval_GWAS3', 'Pval_IIBDGC', 'Pval_IBDseq', 'HetPVal', 'HetDf', 'HetChiSq', 'HetISq'  ),
                      path =  'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/uc_delange-2017.txt')
...
fwrite(psc_ok, file= 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/psc_ji-2016.txt',
...
fwrite(t1_ok_no_X, 'outputs/2_gwas_uc-cd-psc-ra-sle-t1d-jia-asthma-derma/01_qc_summary_stats/t1d_chiou-2021.txt',
