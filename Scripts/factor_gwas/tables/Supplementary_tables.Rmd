...
## Supplementary table S1, EFA models
...
## Supplementary table S5, colocalization results
...
## Supplementary table S7, genomic regions all traits and factors
...
## Supplementary table S10,top 10 GO terms

```{r}

```

## Supplementary table S11, eQTL colocalization results
```{r}
